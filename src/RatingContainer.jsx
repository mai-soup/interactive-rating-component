  ...
  return (
    <div className="grow flex justify-center items-center">
      <Card className="w-4/5 sm:w-[400px] ">
        {!isSubmitted && (
          <>
            <div className="bg-dark-blue text-light-grey p-3 rounded-full h-12 w-12 flex justify-center items-center">
            ...
            <button
              className="bg-orange-500 mx-auto block text-white enabled:hover:bg-orange-700 w-1/2 rounded-full h-12 disabled:opacity-50"
        ...
        {isSubmitted && (
          <div className="text-center">
            <img
              ...
              className="mx-auto"
            />
            <div className="bg-dark-blue text-orange-500 rounded-full w-1/2 h-8 flex justify-center items-center mx-auto">
